...
1. **Этап 1: Проектирование (GigaChat).** Генерация структуры урока и текста лекции. *Действие:* Ввод промпта с темой. *Результат:* Текстовый план (lesson_plan.md).
2. **Этап 2: Контроль (DeepSeek).** На основе лекции из этапа 1 создаем тест из 5 вопросов. *Действие:* Запрос на создание вопросов с ключами. *Результат:* Текст теста (test_questions.md).
